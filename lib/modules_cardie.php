...
echo "<html>
	...
	//$util_connecte = $_SESSION['identifiant'];
		echo "<tr>";
			...
			{
				echo "<td align=\"center\" valign=\"top\" nowrap>&nbsp;<a href = \"personnes_ressources_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Personnes ressources TICE\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/personnes_ressources.png\" ALT = \"Personnes ressources\" border=\"0\"></a></td>";
			}
			...
			{
				echo "<td align=\"center\" valign=\"top\" nowrap>&nbsp;<a href = \"dev_taches_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Suivi Collaboratice\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/dev_taches.png\" ALT = \"SUIVIColTICE\" border=\"0\"></a></td>";
			}
