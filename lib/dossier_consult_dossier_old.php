...
<?php
	...
	echo "<body>
		<div align = \"center\">";
			...
			// Les éléments à aficher ou à cacher
			$affiche_suivis_dossier = $_GET['affiche_suivis_dossier']; //pour savoir s'il faut afficher les suivis du dossier
			$affiche_taches_dossier = $_GET['affiche_taches_dossier']; //pour savoir s'il faut afficher les tâches du dossier
			...
			//////////////////////////////////////////////////////////////
			// Affichage des variables pour contrôle /////////////////////
			//////////////////////////////////////////////////////////////
			...
			*/
			...
			////////////////////////////////////////////////////////////////////////////////////////////////
			// Début des actions à faire sur le dossier ////////////////////////////////////////////////////
			////////////////////////////////////////////////////////////////////////////////////////////////

			if($action=="O") // Des modifications ont &eacute;t&eacute; apport&eacute;es
			{
...
*/
			...
			$query = "SELECT * FROM categorie_commune AS cc, dos_dossier AS dd WHERE cc.id_categ = dd.idDossier AND idDossier = '".$id_dossier."';";
