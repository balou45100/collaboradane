...
$id=explode("/",$ids."////");
$chp=array("ville","RNE","nom"); // Les noms des champs
...
// identifiant, libellé où identifiant est numérique auto-incrémenté
   case "1": // Liste des produits (ex : que des stylos )  
      $query = "SELECT RNE, nom FROM etablissements ".$w." ORDER BY nom";
...
//  Si q n'est ni 1, ni 2, ni 3, il faut préparer le 0 ;)
   ...
   $liste_dpt = "";
   $SQL = "SELECT RNE, ville FROM etablissements ORDER BY ville";
   $res = mysql_query($SQL);
