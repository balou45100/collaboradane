...
<?php
	...
	$util_connecte = $_SESSION['nom'];
		echo "<TR>";
			//echo "<td align = \"left\"><small>$util_connecte<br>$date_aujourdhui</small></td>";
			//echo "<td class=\"IconesAvecTexte\" align=\"center\" valign=\"top\" nowrap>";
			echo "<td align=\"center\">";
				echo "<A HREF = \"accueil_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Accueil\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/accueil.png\" ALT = \"Tableau de bord\" border=\"0\"></A><small><br />Accueil</small>";
				...
				//echo "<br /><A HREF = \"cadre_gestion_ecl.php\" target = \"_top\" class=\"bouton\" title=\"&Eacute;coles, coll&egrave;ges, lyc&eacute;es\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/eple.png\" ALT = \"ECL\" border=\"0\"></A><small><br />R&eacute;p. ECL</small>";
				//echo "<br /><A HREF = \"cadre_gestion_ticket.php\" target = \"_top\" class=\"bouton\" title=\"Gestion tickets\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/ticket.png\" ALT = \"Gestion tickets\" border=\"0\"></A><small><br />Tickets</small>";
				//echo "<br /><A HREF = \"personnes_ressources_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Personnes ressources TICE\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/personnes_ressources.png\" ALT = \"Personnes ressources\" border=\"0\"></A><small><br />Pers. ress.</small>";
				//echo "<br /><A HREF = \"formations_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Formations\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/formations.png\" ALT = \"Formations\" border=\"0\"></A><small><br />Formations";
				//echo "<br /><A HREF = \"repertoire_cadre.php\" target = \"_top\" class=\"bouton\" title=\"R&eacute;pertoires  des soci&eacute;t&eacute;s\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/repertoire.png\" ALT = \"R&eacute;pertoire\" border=\"0\"></A><small><br />Rép. soci&eacute;t&eacute;</small>";
				//echo "<br /><A HREF = \"contacts_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Contacts des soci&eacute;t&eacute;s\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/contacts.png\" ALT = \"Contacts\" border=\"0\"></A><small><br />Contacts</small>";
				echo "<br /><A HREF = \"contacts_prives_cadre.php\" target = \"_top\" class=\"bouton\" title=\"Contacts privés\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/contacts_prives.png\" ALT = \"Contacts privés\" border=\"0\"></A><small><br />C. priv&eacute;s</small>";
