<?php
	...
	*/
	...
	if (mysql_num_rows($result_partenaire_salon))
	{
		...
		$a_traiter_salon = $ligne->a_traiter;
		$contacte_salon = $ligne->contacte;
		$handicap_salon = $ligne->handicap;
		$detail_handicap_salon = $ligne->detail_handicap;
		...
		<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
			<CAPTION><b>D&eacute;tails du suivi</b></CAPTION>
			<tr CLASS = \"new\">
				<td width = \"10%\">";
				...
				echo "<td width = \"10%\">";
					$checked=Testpourcocher($a_traiter_salon);
					echo "&agrave; traiter&nbsp;:&nbsp;
					<input type=\"checkbox\" name=\"a_traiter_salon\" value=\"1\" $checked>
				</td>";
				echo "<td width = \"10%\">";
					$checked=Testpourcocher($contacte_salon);
					echo "contact&eacute;&nbsp;:&nbsp;
					<input type=\"checkbox\" name=\"contacte_salon\" value=\"1\" $checked>
				</td>";
				echo "<td width = \"70%\" BGCOLOR = \"#48D1CC\">&nbsp;</td>";
			echo "</tr>";
		echo "</table>";
		echo "<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
			<tr CLASS = \"new\">
				<td width = \"55%\">Exposition&nbsp;:&nbsp;";
					$checked=Testpourcocher($interesse_pour_exposition);
					echo "intéress&eacute;-e&nbsp;<input type=\"checkbox\" name=\"interesse_pour_exposition\" value=\"1\" $checked>&nbsp;";
			...
			<tr CLASS = \"new\">";
				echo "<td width = \"20%\">";
					$checked=Testpourcocher($handicap_salon);
					echo "Parcours handicap&nbsp;:&nbsp;
					<input type=\"checkbox\" name=\"handicap_salon\" value=\"1\" $checked>
				</td>";
/*
				echo "<td width = \"45%\">";
...
*/
					...
					{
						echo "<td width = \"80%\">
							D&eacute;tail&nbsp:&nbsp;<input type=\"text\" name=\"detail_handicap_salon\" value=\"$detail_handicap_salon\" size=\"50\">";
						echo "</td>";
					}
					else
					{
						echo "<td width = \"80%\" BGCOLOR = \"#48D1CC\">&nbsp;</td>";
					}
			echo "</tr>";
		echo "</table>";
		echo "<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
			<tr CLASS = \"new\">
				<td width =\"45%\">logo sur affiche&nbsp;:&nbsp;";
					$checked=Testpourcocher($logo_sur_affiche);
					echo "<input type=\"checkbox\" name=\"logo_sur_affiche\" value=\"1\" $checked>&nbsp;&nbsp;";
				echo "</td>";
				echo "<td width =\"20%\">afficher dans la page partenaire&nbsp;:&nbsp;";
				echo "</td>";
				echo "<td width = \"35%\">";
		...
		if ($participation_agora == 1 OR $participation_exposition == 1 OR $logo_sur_affiche == 1)
		{
			...
			echo "<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
				<tr CLASS = \"new\">
					<td width = \"15%\" align = \"center\">participation financière&nbsp;:&nbsp;<br />
					<input type=\"text\" value = \"$nombre_a_afficher\" name=\"participation_financiere\" size=\"10\">
					<td width = \"70%\">Description pour le salon&nbsp;:&nbsp;<br />
						<TEXTAREA name=\"description_pour_salon\" rows=10 cols=80>$description_pour_salon</TEXTAREA>";
						echo "<script type=\"text/javascript\">
							CKEDITOR.replace( 'description_pour_salon' );
							</script></td>";
					echo "</td>
					...
					<td width = \"15%\" align = \"center\">";
						...
						echo "Afficher la description pour le salon&nbsp;:&nbsp;<br /><input type=\"checkbox\" name=\"afficher_description_salon\" value=\"1\" $checked>
					</td>
