...
<!"Ce fichier permet de gérér les crédits gérés par la Mission académique TICE"
...
////////////////////////////////////////////////////////////////////////////////////////////
				if ($actions_courantes == "O")
				{
					...
					switch ($a_faire)
					{
						...
						case "tableau_bord_credits" :
							//echo "<h1>Ici bient&ocirc;t le tableau de bord des heures</h1>";
							include ("credits_tableau_bord.inc.php");
							$affichage ="N";
						break; //tableau_bord_credits
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
				if ($affichage <> "N")
				{
					if (($autorisation_personnes_ressource == "1") AND ($en_liste <>"Oui")) //Seul les personnes ayant le droit peuvent insérer une nouvelle personnes ressource
					{
						//echo "<A HREF = \"credits_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=ajout_personne\" class = \"bouton\">Ins&eacute;rer une nouvelle personne ressource</A>&nbsp;-&nbsp;";
						echo "<A HREF = \"credits_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=tableau_bord_credits\" class = \"bouton\">Tableau de bord des cr&eacute;dits</A>";
					}
					switch ($dep)
					{
						case 'T' :
						...
						<TABLE BORDER=\"0\" ALIGN=\"CENTER\" BGCOLOR = \"#48D1CC\">
							<TR>
								...
								}else
								{
									...
									echo "<TD align=\"center\">Nom_etab</TD>";
									echo "<TD align=\"center\">Ville_etab</TD>";
								}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									if ($en_liste <> "Oui")
									{
										echo "<TD BGCOLOR = \"#48D1CC\">";
											echo "<A HREF = \"personnes_ressources_gestion.php?actions_courantes=O&amp;a_faire=consulter_personne&amp;id=".$id."&amp;indice=".$indice."&amp;tri=".$tri."&amp;sense_tri=".$sense_tri."\" target = \"body\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/info.gif\" ALT = \"consulter\" title=\"Consulter la fiche de la personne\"></A>";
										if ($autorisation_personnes_ressource == "1")
										{
											echo "<A HREF = \"personnes_ressources_gestion.php?actions_courantes=O&amp;a_faire=modif_personne&amp;id=".$id."&amp;indice=".$indice."\" target = \"body\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/modifier.png\" ALT = \"modifier\" title=\"Modifier la fiche de la personne\"></A>";
											echo "<A HREF = \"personnes_ressources_gestion.php?actions_courantes=O&amp;a_faire=saisir_fonction&amp;id=".$id."&amp;indice=".$indice."\" target = \"body\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/alerte.png\" ALT = \"modifier\" height=\"24px\" width=\"24px\" title=\"Saisir une fonction pour la personne\"></A>";
											...
											echo "<A HREF = \"personnes_ressources_gestion.php?actions_courantes=O&amp;a_faire=supprimer_personne&amp;id=".$id."&amp;indice=".$indice."\" target = \"body\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/supprimer.png\" ALT = \"supprimer\" height=\"24px\" width=\"24px\" title=\"Supprimer la personne\"></A>";
										}
											echo "</TD>";	
										echo "</TR>";
									}
