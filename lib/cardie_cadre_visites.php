...
<?php
	...
	{
		enreg_utilisation_module("CARDIEVIS");
	}
	echo "
...
<html>
	<head>
		...
		<frameset rows=\"60,*,65\">
			<frame name=\"head\" src=\"cardie_entete_visites.php\" FRAMEBORDER=\"0\" scrolling=\"no\">
			<frame name=\"body\" src=\"cardie_gestion_visites.php\" FRAMEBORDER=\"0\">
