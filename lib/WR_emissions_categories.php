<?php
	...
	echo "<html>
	<head>
  		<title>Webradio - Cat&eacute;gories</title>
		<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />
		<link href=\"$theme\" rel=\"stylesheet\" type=\"text/css\" />
		<script type=\"text/javascript\" src=\"../ckeditor/ckeditor.js\"></script>";
	echo "</head>";
	echo "<body>";
		$script = "emissions_categories";
		$test = include ("WR_menu_barre.php");
		//echo "<br />test : $test";
		
		echo "<div id = \"barre_module_14\">&nbsp;</div>";
		...
		echo "<div align = \"center\">";
			...
			echo "<h1>Gestion des cat&eacute;gories des &eacute;missions</h1>";
				...
				/*
				//echo "<br><b>***WR_emissions_categories.php***</b>";
				...
				if ($action == "O")
				{
					...
					switch ($a_faire)
					{
						case "ajout_categorie" :
							...
							echo "<form id=\"monForm\" action=\"WR_emissions_categories.php\" method=\"get\">
								<fieldset>
						...
						case "enreg_categorie" :
							...
							$requete_enreg = "INSERT INTO WR_EmissionsCategories (
							`EmissionsCategorieNom`
							)
							VALUES ('".$intitule."');";
						...
						case "modifier_categorie" :
							...
							$requete_categorie = "SELECT * FROM WR_EmissionsCategories WHERE idEmissionsCategorie = '".$id."'";
							...
							$idEmissionsCategorie = $ligne_categorie->idEmissionsCategorie;
							$EmissionsCategorieNom_a_modifier = $ligne_categorie->EmissionsCategorieNom;
							echo "<form id=\"monForm\" action=\"WR_emissions_categories.php\" method=\"get\">
							<fieldset>
							<legend>MODIFICATION</legend>
								<p>
									<label for=\"form_no_srie\">D&eacute;nomination&nbsp;:&nbsp;</label>
									<input type=\"text\" id=\"form_intitule\" VALUE = \"$EmissionsCategorieNom_a_modifier\"name=\"intitule\" />
								</p>
							</fieldset>
								<p>
						...
						case "maj_categorie" :
							...
							$requete_maj = "UPDATE WR_EmissionsCategories SET EmissionsCategorieNom = '".$intitule."' WHERE idEmissionsCategorie = '".$id."';";
						...
						case "supprimer_categorie" :
							...
							$requete = "SELECT * FROM WR_EmissionsCategories WHERE idEmissionsCategorie = '".$id."';";
							...
							$intitule = $ligne_extraite->EmissionsCategorieNom;
							$idEmissionsCategorie = $ligne_extraite->idEmissionsCategorie;
							echo "<FORM ACTION = \"WR_emissions_categories.php\" METHOD = \"GET\">";
						...
						case "confirme_supprimer_categorie" :
							$id = $_GET['id'];
							$requete_suppression = "DELETE FROM WR_EmissionsCategories WHERE idEmissionsCategorie =".$id.";";
...
////////////////////////////////////////////////////////////////////////////////////////////
				...
				$query = "SELECT * FROM WR_EmissionsCategories ORDER BY EmissionsCategorieNom";
				...
				if ($affichage <> "N")
				{
					echo "<div align = \"center\">";
						echo "<table class = \"menu-boutons\">";
							echo "<tr>";
								echo "<td>";
									echo "<a href = \"WR_emissions_categories.php?action=O&amp;a_faire=ajout_categorie\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/ajout.png\" ALT = \"Nouveau\" title=\"Ins&eacute;rer une nouvelle fiche\" align=\"top\" border = \"0\"></a><br /><span class=\"IconesAvecTexte\">Ajouter une cat&eacute;gorie</span><br />";
								echo "</td>";
							echo "</tr>";
						echo "</table>";
					echo "</div>";
					...
					//echo "<a href = \"WR_emissions_categories.php?action=O&amp;a_faire=ajout_categorie\"><img src= \"../image/ajout.png\" title = \"Ajouter une cat&eacute;gorie\"></a><br />Ajouter une cat&eacute;gorie ";
					...
					if ($num_results >0)
					{
						...
						echo "<TABLE>
							...
							echo "<TR>";
								...
								while ($ligne = mysql_fetch_object($results)) // on extrait ligne par ligne de la table WR_EmissionsCategories
								{
									$id = $ligne->idEmissionsCategorie;
									$intitule = $ligne->EmissionsCategorieNom;
									if ($id <>"")
									{
										echo "<tr>";
										...
										echo "<td nowrap class = \"fond-actions\">";
											echo "<A HREF = \"WR_emissions_categories.php?action=O&amp;a_faire=modifier_categorie&amp;id=$id\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/modifier.png\" ALT = \"modifier\" title=\"Modifier\"></A>";
											echo "<A HREF = \"WR_emissions_categories.php?action=O&amp;a_faire=supprimer_categorie&amp;id=$id\" TARGET = \"body\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/supprimer.png\" ALT = \"supprimer\" title=\"Supprimer le mat&eacute;riel\"></A>";
										echo "</TD>";
										echo "</TR>";
									} //Fin id <> ""
								} //fin boucle while
