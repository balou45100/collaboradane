...
<head>
	...
	<div id = \"entete-collaboratice\" align = \"center\">
		<h2>$nom_espace_collaboratif<br />$description_espace_collaboratif</h2>
		...
		<img class = \"titre2\" src=\"$chemin_theme_images/titres_modules/titre_accueil.png\" ALT = \"Titre\">
	</div>
	<div id = \"body_tb\">";
		...
		else
		{
			...
			//echo "&nbsp";
			echo"<br />";
			echo"<iFRAME SRC=tb_taches.php?vue=tb width=48% height=30% name=HautDroite MARGINWIDTH=10 MARGINHEIGHT=20></iframe>";
			echo "&nbsp";
			//echo"<br />";
			...
			{
				echo"<iFRAME SRC=tb_prets.php?vue=tb width=48% height=30% name=BasCentre MARGINWIDTH=10 MARGINHEIGHT=20></iframe>";
				echo"<br />";
				//echo "&nbsp";
	...
	echo "</div>";
	mysql_free_result ($resultat_verif_pref);
?>
<!--/center-->
</html> 
