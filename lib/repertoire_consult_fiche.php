			...
			*/
			...
			if($CHGMT=="O") // Des modifications ont été apportées
			{
				...
				if ($part_salon == "1")
				{
					...
					else
					{
						...
						if ($num_results == 0) //la fiche n'existe pas
						{
							...
							if(!$results_ajout)
							{
								echo "<B>Création : Erreur de connexion à la base de données ou erreur de requète</B>";
								//echo "<BR> <A HREF = \"consult_ticket.php?tri=$tri&amp;CST=N&amp;idpb=".$idpb_pere."&amp;id_categ=".$id_categ."\" class = \"bouton\">Retour au ticket</A>";
								//mysql_close();
								//exit;
							}
				...
				elseif ($part_salon == "0") //Je dois supprimer la fiche de suivi
				{
					...
					{
						echo "<B>Suppression : Erreur de connexion à la base de données ou erreur de requète</B>";
						//echo "<BR> <A HREF = \"consult_ticket.php?tri=$tri&amp;CST=N&amp;idpb=".$idpb_pere."&amp;id_categ=".$id_categ."\" class = \"bouton\">Retour au ticket</A>";
						//mysql_close();
						//exit;
					}
...
///////////////////////////////////////////////////////////////////////////////
				switch ($action)
				{
					...
					case ('enreg_suivi') : //il y a eu des changements dans le formulaire de suivi du Festival des Génies du Multimédia
						...
						*/
						...
						$query_maj = "
							UPDATE fgmm_suivi_partenaires SET
						...
						$results_maj = mysql_query($query_maj); 
						$query_maj = "
							UPDATE fgmm_hist_particip_partenaires SET
						...
						$results_maj = mysql_query($query_maj); 
						$query_maj = "
							UPDATE fgmm_part_financiere_partenaires SET
								montant95 = '".$montant95."',
								montant96 = '".$montant96."',
								montant97 = '".$montant97."',
								montant98 = '".$montant98."',
					...
					case ('enreg_lot_ajoute') : //enregistrement d'un lot modifié
						...
						if(!$results)
						{
							echo "<B>EEErreur de connexion à la base de données ou erreur de requète</B>";
							//echo "<BR> <A HREF = \"consult_ticket.php?tri=$tri&amp;CST=N&amp;idpb=".$idpb_pere."&amp;id_categ=".$id_categ."\" class = \"bouton\">Retour au ticket</A>";
							//mysql_close();
							//exit;
						}
					...
					case ('enreg_suivi_salon') : //il y a eu des changements dans le formulaire de suivi du Festival des Génies du Multimédia
						...
						*/
						...
						//Tables concernées : part_financiere_partenaires_fgmm,fgmm_hist_particip_partenaires,suivi_partenaires
						$query_maj = "
							UPDATE salon_suivi_partenaires SET
								...
								intervention_agora = '".$intervention_agora."',
			...
			switch ($action)
			{
				case ('modif') :
					echo "<FORM ACTION = \"repertoire_consult_fiche.php\" METHOD = \"GET\">";
					echo "<h2>Détails de l'enregistrement à modifier</h2>";
					echo "<TABLE width=\"95%\">
						<tr>
							<td class = \"etiquette\" width = \"5%\">Id&nbsp;:&nbsp;";
							echo "<td width = \"5%\">$id_societe&nbsp;&nbsp;</td>";
							echo "<td class = \"etiquette\">Soci&eacute;t&eacute;&nbsp;:&nbsp;</td>";
							echo "<td><input type=\"text\" value = \"$societe\" name=\"societe\" size=\"30\">&nbsp;&nbsp;</td>";
							echo "<td class = \"etiquette\" nowrap>&agrave; traiter&nbsp;</td>";  
							...
							echo "<td class = \"etiquette\">contact&eacute;&nbsp;</td>";
							echo "<td><input type=\"checkbox\" name=\"contacte\" value=\"1\" $checked>&nbsp;&nbsp;</td>"; 
							echo "<td class = \"etiquette\" nowrap>date&nbsp;(aaaa-mm-jj)&nbsp;:&nbsp;</td>";
							...
							echo "<td class = \"etiquette\">&eacute;diteur&nbsp;";  
						...
						echo "</tr>";
						echo "<tr>";
							echo "<td class = \"etiquette\" colspan = \"3\">Adresse&nbsp;:&nbsp;</td>";
							echo "<td><input type=\"text\" value = \"$adresse\" name=\"adresse\" size=\"30\">&nbsp;</td>";
							echo "<td class = \"etiquette\">CP&nbsp;:&nbsp;</td>";
							echo "<td><input type=\"text\" value = \"$cp\" name=\"cp\" size=\"6\">&nbsp;</td>";
							echo "<td class = \"etiquette\">Ville&nbsp;:&nbsp;</td>";
							echo "<td colspan = \"7\"><input type=\"text\" value = \"$ville\" name=\"ville\" size=\"50\"></td>";
							echo "<td class = \"etiquette\">Pays&nbsp;:&nbsp;</td>";
							echo "<td colspan = \"5\"><input type=\"text\" value = \"$pays\" name=\"pays\" size=\"20\"></td>";
						echo "</tr>";
						echo "<tr>
							<td  class = \"etiquette\" colspan=\"3\" nowrap>Site Web&nbsp;:&nbsp;</td>";
							echo "<td colspan=\"3\"><input type=\"text\" value = \"$internet\" name=\"internet\" size=\"50\">&nbsp;</td>";
							echo "<td class = \"etiquette\" nowrap>t&eacute;l Standard&nbsp;:&nbsp;</td>";
							echo "<td><input type=\"text\" value = \"$tel_standard\" name=\"tel_standard\" size=\"14\">&nbsp;</td>";
							echo "<td class = \"etiquette\">fax&nbsp;:&nbsp;</td>";
							echo "<td><input type=\"text\" value = \"$fax\" name=\"fax\" size=\"15\">&nbsp;</td>";
							echo "<td class = \"etiquette\">m&eacute;l&nbsp;:&nbsp;</td>";
							echo "<td colspan=\"9\"><input type=\"text\" value = \"$email\" name=\"email\" size=\"40\"></td>";
						echo "</tr>";
					//echo "</TABLE>";
					//echo "<TABLE width=\"95%\">";
						echo "<tr>
							<TD class = \"etiquette\" colspan = \"3\">Remarques&nbsp;:&nbsp;</TD>
							<TD colspan = \"11\"><textarea rows=\"4\" name=\"remarques\" cols=\"100\">$remarques</textarea></TD>";
							if ($emetteur == $_SESSION['nom'])
							{
								echo "<TD class = \"etiquette\">Confidentialit&eacute;&nbsp;:&nbsp;</TD>";
									echo "<td colspan=\"5\"><select size=\"1\" name=\"statut\">
									...
									<TABLE width=\"95%\">
										...
										for($i = 0; $i < $num_results_contacts; ++$i)
										{
											echo "<tr>
												...
												echo "<td width=\"5%\" class = \"#fond-actions\">
					...
					case ('affichage') :
						...
						echo "<TABLE width=\"95%\">
							...
							<tr>
								...
								<td class = \"etiquette\" >Soci&eacute;t&eacute;&nbsp;:&nbsp;</td>
						...
						//echo "<TABLE width=\"95%\">";
							echo "<tr>";
								echo "<td class = \"etiquette\" colspan =\"3\">Site Web&nbsp;:&nbsp;</td>
								<td colspan =\"5\">&nbsp;<a href=\"$internet\" target=\"_blank\">$internet</a></td>
								<td class = \"etiquette\">t&eacute;l Standard&nbsp;:&nbsp;</td>";
								$tel_standard = affiche_tel($tel_standard);
								echo "<td>&nbsp;$tel_standard</td>
						...
						if ($remarques <> "")
						{
							//echo "<TABLE width=\"95%\">";
								echo "<tr>
									<TD class = \"etiquette\" colspan =\"3\">Remarques&nbsp;:&nbsp;</TD>
									<TD colspan =\"13\">&nbsp;$remarques</TD>";
								if ($emetteur == $_SESSION['nom'])
								{
									echo "<td class = \"etiquette\">Confidentialit&eacute;&nbsp;:&nbsp;</td>";
										echo "<td colspan=\"3\"><select size=\"1\" name=\"statut\">
											<option selected value=\"$statut\">$statut</option>
											<option value=\"public\">Public (visible pour tous)</option>
											<option value=\"privé\">Privé (visible uniquement au propriétaire)</option>
										</select>
						...
						echo "<TABLE width=\"95%\">
							...
							if ($part_fgmm == "1") //on regarde si cet enregistrement est marqué être partenaire du festival des Génies du Multimédia
							{
								if ($affiche_FGMM <> "O")
								{
									echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_FGMM=O&amp;affiche_salon=N&amp;affiche_tickets=N&amp;affiche_tickets_archives=N\" target=\"body\"><b>Afficher les d&eacute;tails pour $bt_manifestation</b></A></TD>";
								}
								else
								{
									echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_FGMM=N\" target=\"body\" class = \"bouton\"><b>Cacher les d&eacute;tails pour $bt_manifestation</b></A></TD>";
								}
							}
							else
							{
							...
							if ($part_salon == "1") //on regarde si cet enregistrement est marqué être exposant des différentes manifestations
							{
								if ($affiche_salon <> "O")
								{
									echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_salon=O&amp;affiche_FGMM=N&amp;affiche_tickets=N&amp;affiche_tickets_archives=N\" target=\"body\"><b>Afficher les d&eacute;tails pour $bt_salon</b></A></TD>";
								}
								else
								{
									echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_salon=N\" target=\"body\" class = \"bouton\"><b>Cacher les d&eacute;tails pour $bt_salon</b></A></TD>";
								}
							}
							else
							{
							...
							{
								echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_tickets=O&amp;affiche_FGMM=N&amp;affiche_salon=N&amp;affiche_tickets_archives=N\" target=\"body\" class = \"bouton\"><b>Afficher les tickets en cours</b></A></TD>";
							}
							else
							{
								echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_tickets=N&amp;affiche_FGMM=$affiche_FGMM\" target=\"body\" class = \"bouton\"><b>Cacher les tickets en cours</b></A></TD>";
							}

							if ($affiche_tickets_archives <> "O") //on affiche ou on cache les tickets concernant cet enregistrement
							{
								echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_tickets_archives=O&amp;affiche_tickets=N&amp;affiche_FGMM&amp;affiche_salon=N\" target=\"body\" class = \"bouton\"><b>Afficher les tickets archiv&eacute;s</b></A></TD>";
							}
							else
							{
								echo "<TD width = \"25%\" align = \"center\"><A HREF=\"repertoire_consult_fiche.php?affiche_tickets_archives=N&amp;affiche_tickets=$affiche_tickets&amp;affiche_FGMM\" target=\"body\" class = \"bouton\"><b>Cacher les tickets archiv&eacute;s</b></A></TD>";
							}
							echo "</TR>
						</TABLE>";
