				...
				if (($autorisation_cardie == "1") //Affichage pour les personnes appartenant au groupe Cardie
				{
					echo "<div align = \"center\">";
						echo "<table class = \"menu-boutons\">";
							echo "<tr>";
								echo "<td>";
									echo "<a href = \"cardie_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=ajout_personne\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/personne_ressources_ajout.png\" ALT = \"Ajouter personne\" border = \"0\"></a><br /><span class=\"IconesAvecTexte\">Ajouter une personne ressource</span><br />";
								echo "</td>";
								echo "<td>";
									echo "<a href = \"cardie_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=tableau_bord_heures\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/heures.png\" ALT = \"Tableau bord heures\" border = \"0\"></a><br /><span class=\"IconesAvecTexte\">Tableau de bord des heures</span><br />";
								echo "</TD>";
							echo "</tr>";
						echo "</table>";
					echo "</div>";
					...
					//echo "<A HREF = \"cardie_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=ajout_personne\" class = \"bouton\">Ins&eacute;rer une nouvelle personne ressource</A>&nbsp;-&nbsp;";
					//echo "<A HREF = \"cardie_gestion.php?origine_gestion=filtre&amp;actions_courantes=O&amp;a_faire=tableau_bord_heures\" class = \"bouton\">Tableau de bord des heures</A>";
				}
				switch ($dep)
				{
					case 'T' :
