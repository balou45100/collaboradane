...
<?php
	...
	{
		enreg_utilisation_module("CARDIE");
	}
	echo "
...
<html>
	<head>
		<title>Cardie</title>
				...
				<frameset rows=\"60,*,65\">
	        <frame name=\"head\" src=\"cardie_entete.php\" FRAMEBORDER=\"0\" scrolling=\"no\">
	        <frame name=\"body\" src=\"cardie_gestion.php?dep=T&amp;secteur=T&amp;intitule_fonction=T&amp;annee=$annee_en_cours&amp;origine=cadre_gestion\" FRAMEBORDER=\"0\">
