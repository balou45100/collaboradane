...
<?php
	...
	echo "<TABLE align=\"center\" width = \"95%\" height=\"10%\" BORDER = \"0\" BGCOLOR =\"#FFFF99\">
		...
		else
		{
			...
			echo"<br>";
			echo"<iFRAME SRC=tb_tickets.php?vue=tb width=48% height=40% name=HautGauche MARGINWIDTH=10 MARGINHEIGHT=20>
			</iframe>";
			echo "&nbsp &nbsp";
			...
			*/
			...
			//if ($util == "admin")
			{
				echo"<iFRAME SRC=tb_prets.php?vue=tb width=48% height=20% name=BasCentre MARGINWIDTH=10 MARGINHEIGHT=20>
				</iframe>";
				echo"<br><br>";
				echo"<iFRAME SRC=tb_garanties.php?vue=tb width=48% height=20% name=BasDroite MARGINWIDTH=10 MARGINHEIGHT=20>
				</iframe>";
				echo "&nbsp &nbsp";
				echo"<iFRAME SRC=tb_pers_form.php?vue=tb width=48% height=20% name=BasGauche MARGINWIDTH=10 MARGINHEIGHT=20>
				</iframe>";
				//echo"<br><br>";
