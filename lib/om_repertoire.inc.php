...
<tr><td><p>Indiquez le numéro de salle:&nbsp;</p></td>
<td><input type="text" name="numsalle1" size="17" /></td>
<td><input type="submit" name="valid_etab1" value="Valider"/></td></tr>
<input type="hidden" name="typelieu" value="2"/>
<input type="hidden" name="Suivant2" value="XX"/>
</table>
</form></center>';
...
<table border=0 cellpading=0>
<tr><td><p>Indiquez le numéro de salle:&nbsp;</p>
</td><td><input type="text" name="numsalle2" size="17" /></td>
<td><input type="submit" name="valid_etab2" value="Valider"/></td></tr>
<input type="hidden" name="typelieu" value="2"/>
<input type="hidden" name="Suivant2" value="XX"/>
</table>
</form></center>';
...
if(isset($_POST["valid_etab1"]))
{
 ...
 $requete1 = "INSERT INTO `collaboratice`.`om_salle` (`idsalle`, `idRNE`, `idNo_societe`, `intitule_salle`) VALUES ('', '', '$idE', '$numsalle1');";
...
if(isset($_POST["valid_etab2"]))
{
 ...
 $requete2 = "INSERT INTO `collaboratice`.`om_salle` (`idsalle`, `idRNE`, `idNo_societe`, `intitule_salle`) VALUES ('', '', '$idE', '$numsalle2');";
