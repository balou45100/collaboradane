...
*/
	...
	echo "<head>";
		...
		echo "<meta HTTP-EQUIV=\"Refresh\" CONTENT=\"600 url=dossier_barre_modules.php\">";
	...
	//$util_connecte = $_SESSION['identifiant'];
		echo "<tr>";
			...
			if ($autorisation_gestion_om == "1")
			{
				...
				echo "<td align=\"center\" valign=\"top\" nowrap>&nbsp;<a href = \"ef_cadre.php\" target = \"_top\" class=\"bouton\" title=\"OM\"><img height=\"$hauteur_icone_menu\" width=\"$largeur_icone_menu\" src = \"$chemin_theme_images/ef.png\" ALT = \"OM\" border=\"0\"></a></td>";
			}
