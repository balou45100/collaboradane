...
<?php
	...
	{
		enreg_utilisation_module("CARDIEACC");
	}
	echo "
...
<html>
	<head>
		...
		<frameset rows=\"60,*,65\">
			<frame name=\"head\" src=\"cardie_entete_accompagnateurs.php\" FRAMEBORDER=\"0\" scrolling=\"no\">
			<frame name=\"body\" src=\"cardie_gestion_accompagnateurs.php\" FRAMEBORDER=\"0\">
