...
<!"Ce fichier affiche la liste de tous les participants au salon du Festival des Génies du Multimédia">
...
*/
            ...
            case "SALON_INT" :
							$intitule_tableau = "Les partenaires interessés pour participer au salon";
                switch ($tri)
                {
                  case "ID" :
                    $query = "SELECT * FROM repertoire, fgmm_suivi_partenaires WHERE id_societe = No_societe AND part_fgmm = '1' AND interesse_pour_salon = '1' ORDER BY No_societe $sense_tri;";
                  break;
                  
                  case "SO" :
                    $query = "SELECT * FROM repertoire, fgmm_suivi_partenaires WHERE id_societe = No_societe AND part_fgmm = '1' AND interesse_pour_salon = '1' ORDER BY societe $sense_tri;";
                  break;
            ...
            case "SALON_PART" :
							$intitule_tableau = "Les partenaires qui participent au salon";
                switch ($tri)
                {
                  case "ID" :
                    $query = "SELECT * FROM repertoire, fgmm_suivi_partenaires WHERE id_societe = No_societe AND part_fgmm = '1' AND participation_salon = '1' ORDER BY No_societe $sense_tri;";
                  break;
                  
                  case "SO" :
                    $query = "SELECT * FROM repertoire, fgmm_suivi_partenaires WHERE id_societe = No_societe AND part_fgmm = '1' AND participation_salon = '1' ORDER BY societe $sense_tri;";
                  break;
      ...
      {	
          ...
          echo "
			<TABLE BORDER=\"0\" ALIGN=\"CENTER\" BGCOLOR = \"#48D1CC\">
				<CAPTION><b>$intitule_tableau</b></CAPTION>
				<TR>
					<TD align=\"center\">";
					if ($sense_tri =="asc")
		      {
