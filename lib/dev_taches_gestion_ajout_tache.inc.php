<?php
	...
	*/
	...
	//echo "<caption>Renseignements sur la t&acirc;che</caption>";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td class = \"etiquette\" align = \"right\">Module(s)&nbsp;:&nbsp;<br /><small>Il est possible de s&eacute;lectionner plusieurs modules</small></td>";
				$requete_module="SELECT DISTINCT id_module,intitule_module FROM modules_collaboratice ORDER BY intitule_module";
				$result=mysql_query($requete_module);
				$num_rows = mysql_num_rows($result);
			echo "</td>";
			echo "<td>";
				echo "<select size=\"4\" name=\"id_module[]\" multiple>";
