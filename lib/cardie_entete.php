...
<?php
	...
	//echo "<br />nbr : $nbr";
	echo "<form action = \"cardie_gestion.php\" target = \"body\" METHOD = \"GET\">";

		echo "<table style = \"border: 0\">";
			echo "<tr>";
				echo "<td>";
					echo "&nbsp;<b>Filtrer en fonction de la d&eacute;cision de la commision&nbsp;:&nbsp;</b>";
				...
				echo "<td>";
					echo "&nbsp;<b>Type d'accompagnement&nbsp;:&nbsp;</b>";
						...
						echo "<input type = \"hidden\" value = \"entete\" name = \"origine_appel\">";
