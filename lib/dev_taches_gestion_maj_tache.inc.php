...
*/
	...
	$requete_maj = "UPDATE dev_taches SET 
...
*/	
	...
	$requete_maj2 = "UPDATE dev_taches_util SET 
		`statut_cta` = '001'
...
*/
	...
	if ($id_util_traitant == $id_createur)
	{
		...
		$requete_suppression = "DELETE FROM dev_taches_util WHERE id_tache = '".$id."' AND (statut_cta = '100' OR statut_cta = '110' OR statut_cta = '010')";
...
*/		$requete_ajout_traitant = "INSERT INTO `dev_taches_util` (`id_tache`,`id_util`,`statut_cta`)
...
*/
	...
	$requete_suppression = "DELETE FROM dev_taches_util WHERE id_tache = '".$id."' AND id_util = '".$id_util_traitant."' AND statut_cta = '001'";
	$resultat_suppression = mysql_query($requete_suppression);
	if(!$resultat_suppression)
	{
		echo "<h2>Erreur</h2>";
