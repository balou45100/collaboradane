<?php
	...
	*/
	...
	$query_partenaire_rt2008 = "SELECT * FROM rt2008_suivi_partenaires WHERE rt2008_suivi_partenaires.id_societe = '".$id_societe."';";
	$result_partenaire_rt2008 = mysql_query($query_partenaire_rt2008);
	if(!$result_partenaire_rt2008)
	{
		echo "<br>Pas de participation financière enregistré pour cette société";
	}
	$num_rows_partenaire_rt2008 = mysql_num_rows($result_partenaire_rt2008);
	if (mysql_num_rows($result_partenaire_rt2008))
	{
		$ligne=mysql_fetch_object($result_partenaire_rt2008);
		...
		<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
			...
			<tr CLASS = \"new\">
				...
				<td width = \"15%\">
					<input type=\"checkbox\" name=\"a_traiter_rt2008\" value=\"1\" $checked>
				</td>
		...
		if ($participation_agora == 1 OR $participation_exposition ==1 OR $logo_sur_affiche ==1)
		{
			echo "<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
				<tr CLASS = \"new\">
					...
					<td><img src=\"$lien_logo\" height = \"50%\" width = \"50%\">
					</td>
				</TR>
			</table>";
			...
			echo "<TABLE width=\"95%\" BORDER = \"1\" BGCOLOR = \"#48D1CC\">
				<tr CLASS = \"new\">
					...
					<td width = \"70%\"><TEXTAREA name=\"description\" rows=4 cols=60>$description</TEXTAREA></td>
					<!--input type=\"text\" value = \"$description\" name=\"description\" size=\"10\"-->
				</tr>
			</table>";
		}
			...
			<INPUT TYPE = \"hidden\" VALUE = \"enreg_suivi_rt2008\" NAME = \"action\">
