...
<?php
	...
	echo "<body>
		<div align = \"center\">";
$requete_Relance="SELECT * FROM om_relance, om_ordres_mission, om_suivi_om, personnes_ressources_tice WHERE om_ordres_mission.RefOM=om_relance.RefOM and personnes_ressources_tice.id_pers_ress=om_ordres_mission.id_pers_ress and om_ordres_mission.RefOM=om_suivi_om.RefOM;";
