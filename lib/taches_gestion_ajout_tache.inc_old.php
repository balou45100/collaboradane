<?php
	...
	*/
	...
	//echo "<caption>Renseignements sur la t&acirc;che</caption>";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td bgcolor = \"$bg_color1\" rowspan= \"2\" align = \"right\">&Eacute;ch&eacute;ance&nbsp;:&nbsp;</td>";
			/*
			echo "<td class = \"etiquette\">Nombre de jour(s)&nbsp;:&nbsp;</td>";
			echo "<td>
		...
		echo "<tr>";
		*/
			echo "<td class = \"etiquette\">&agrave; partir du&nbsp;:&nbsp;</td>";
			 
			//On insère le script pour la sélection de la date 
?>
			</div>
				<ul >
					<li id="li_9" >
						...
						<span>
							...
							<label for="element_9_2">JJ</label>
						</span>
						<span>
		...
		<span>
			...
			<label for="element_9_3">AAAA</label>
		</span>
...
/*
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td class = \"etiquette\">rappel le&nbsp;:&nbsp;</td>";
			echo "<td>
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td class = \"etiquette\">Visibilit&eacute;&nbsp;:&nbsp;</td>";
			echo "<td colspan = \"2\">
				public&nbsp;<input type=\"radio\" name=\"visibilite\" value=\"PU\" checked=\"checked\"/>
				priv&eacute;&nbsp;<input type=\"radio\" name=\"visibilite\" value=\"PR\" />
			</td>";
		echo "</tr>";
		echo "<tr>";
			echo "<td class = \"etiquette\">Cat&eacute;gorie(s)&nbsp;:&nbsp;<br /><small>Il est possible de s&eacute;lectionner plusieurs cat&eacute;gories</small></td>";
		...
		echo "<tr>";
			echo "<td class = \"etiquette\">&Agrave; traiter par&nbsp;:&nbsp;</td>";
		...
		echo "<tr>";
			echo "<td class = \"etiquette\">Personnes associ&eacute;es&nbsp;:&nbsp;<br /><small>Il est possible de s&eacute;lectionner plusieurs personnes</small></td>";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td class = \"etiquette\">Observations et remarques&nbsp;:&nbsp;</td>";
			echo "<td colspan = \"2\"><textarea rows=\"3\" name=\"observation_tache\" cols=\"60\"></textarea></td>";
		echo "</tr>";
		echo "</table>";
