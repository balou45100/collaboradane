...
<html>
	...
	<form method ="get" action="tb_preferences.php">
		<CENTER>
		...
		if ($exe)
		{
		echo "<h3>Vos pr&eacute;f&eacute;rences ont bien &eacute;t&eacute; mises &agrave; jour</h3>";
		echo "<br><br>";
		echo "<input type=submit value=Retour a href = tb_preferences.php>";
		}
		else
		{
		echo "<h3>Problème lors de l'enregistrement dans la base de données</h3>";
		}
		echo mysql_error();
