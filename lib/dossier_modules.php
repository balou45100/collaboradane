<?php
	...
	include ("../biblio/dossier_modules.css");
...
<html>
	<head>
		...
		<meta HTTP-EQUIV="Refresh" CONTENT="600" url="dossier_modules.php">
	</head>
	<BODY>
	...
	$util_connecte = $_SESSION['nom'];
		echo "<TR>
			...
			if($_SESSION['droit'] == "Super Administrateur")
			{
				...
				<td class=\"IconesAvecTexte\" align=\"center\" valign=\"top\" nowrap><A HREF = \"deconnexion.php\" target = \"_top\" class=\"bouton\" title=\"Déconnexion\"><img height=\"$hauteur_icone_action\" width=\"$largeur_icone_action\" src = \"$chemin_theme_images/sortir.png\" ALT = \"Déconnexion\" border=\"0\"></A><small><br />Quitter</small></td>
			</TR>
		</TABLE>
	</body>
</html>";
