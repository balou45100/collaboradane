...
////// Initialisation des variables ///////////////////////////////////////////////////////
	...
	$requete_createur="SELECT * FROM taches_util WHERE id_tache = '".$id_tache."' AND (statut_cta = '100' OR statut_cta = '110')";
	...
	$requete_traitant="SELECT * FROM taches_util WHERE id_tache = '".$id_tache."' AND (statut_cta = '110' OR statut_cta = '010')";
	...
	//echo "<caption>Renseignements sur la t&acirc;che</caption>";
		...
		echo "<tr>";
			...
			echo "<td class = \"etiquette\">Identifiant de la t&acirc;che&nbsp;:&nbsp;</th>";
			echo "<td>$id</td>";
		echo "</tr>";
		echo "<tr>";
