...
<html>
	<head>
		...
		if ($nb_pb == 1)
		{
		echo "Vous avez $nb_pb prêt de matériel bientôt terminé &nbsp &nbsp";
		}
		else
		{
		echo "Vous avez $nb_pb prêts de matériels bientôt terminés &nbsp &nbsp";
		}
		echo"<input type=submit value='Voir en plein écran' a href= tb_pret_cadre.php><br><br>";
		echo "</form>";
		echo "<table border = 1 bgcolor=#48D1CC align = center><tr><td><center>Nom</center></td><td><center>Catégorie</center></td><td><center>Affecté</center></td><td><center>A rendre dans</center></td><td><center>Infos</center></td></tr>";
		}
		else
		{
		if ($echeance1 == "retard")
		...
		if ($nb_pb == 1)
		{
		echo "Vous avez $nb_pb prêt de matériels non encore rendu &nbsp &nbsp";
		}
		else
		{
		echo "Vous avez $nb_pb prêts de matériels non encore rendus &nbsp &nbsp";
		}
		echo"<input type=submit value='Voir en plein écran' a href= tb_pret_cadre.php><br><br>";
		echo "</form>";
		echo "<table border = 1 bgcolor=#48D1CC align = center><tr><td><center>Nom</center></td><td><center>Catégorie</center></td><td><center>Affecté</center></td><td><center>A rendre depuis</center></td><td><center>Infos</center></td></tr>";
		}
		}
		...
		{
		echo "Vous n'avez aucun problème de prêt de matériels<br>";
		}
		$_SESSION[nb_pb]=$nb_pb;
